...
<main role="main">
    ...
    <section class="jumbotron text-center py-5">
        <div class="container">
            ...
            <p class="text-muted">
                Embeddable and Secure Authentication System in PHP with User Profiles,
                Profile Editing, Login, Signup, Account Verification via 
                Email, Password Reset System and Remember Me Feature.
                
                <hr width="300" class="my-3">

                <sub>
                    This is an example intro page that can be accessed with or without logging into an account.
                    This may be used as a default homepage
                ...
                <sub>
                    Hey if you like this small project,
                    I would like it best if you decide to improve and contribute to it. We are probably
            ...
            <p>
                ...
                class="btn btn-secondary my-2" target="_blank">See Repository</a>
            </p>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                            Version Control application in Laravel using Git for core operationality.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="https://github.com/msaad1999/GitKLiK"
                                    class="btn btn-sm btn-outline-secondary" target="_blank">View</a>
                                    <a href="https://github.com/msaad1999/GitKLiK/archive/master.zip"
                                    class="btn btn-sm btn-outline-secondary" target="_blank">Download</a>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            <p class="card-text"></p>
                            PHP social media website with additional blogs and forums functionality.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="https://github.com/msaad1999/KLiK-SocialMediaWebsite"
                                    class="btn btn-sm btn-outline-secondary" target="_blank">View</a>
                            <a href="https://github.com/msaad1999/KLiK-SocialMediaWebsite/archive/master.zip"
                            class="btn btn-sm btn-outline-secondary" target="_blank">Download</a>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="https://github.com/msaad1999/PHP-Login-System"
                                    class="btn btn-sm btn-outline-secondary" target="_blank">View</a>
                                    <a href="https://github.com/msaad1999/PHP-Login-System/archive/master.zip"
                                    class="btn btn-sm btn-outline-secondary" target="_blank">Download</a>
                                </div>
                                <small class="text-muted">[development concluded]</small>
                            </div>
